...
#### 5.2.1 [数据操纵](数据库/SQL.md#521-数据操纵)

#### 5.2.2 [数据查询](数据库/SQL.md#522-数据查询)

#### 5.2.3 [聚合函数](数据库/SQL.md#523-聚合函数)

#### 5.2.4 [多表](数据库/SQL.md#524-多表)

#### 5.2.5 [子查询](数据库/SQL.md#525-子查询)

#### 5.2.6 [集合操作](数据库/SQL.md#526-集合操作)

#### 5.2.7 [条件聚合](数据库/SQL.md#527-条件聚合)

#### 5.2.8 [日期，数字和字符串函数](数据库/SQL.md#528-日期数字和字符串函数)

#### 5.2.9 [视图](数据库/SQL.md#529-视图)

#### 5.2.10 [存储过程](数据库/SQL.md#5210-存储过程)

#### 5.2.11 [触发器](数据库/SQL.md#5211-触发器)

#### 5.2.12 [事务管理](数据库/SQL.md#5212-事务管理)
