...
#### 5.1.1 [事务](数据库/数据库系统原理.md#511-事务)

#### 5.1.2 [并发一致性问题](数据库/数据库系统原理.md#512-并发一致性问题)

#### 5.1.3 [常见的并发控制](数据库/数据库系统原理.md#513-常见的并发控制)

#### 5.1.4 [多版本并发控制](数据库/数据库系统原理.md#514-多版本并发控制)

#### 5.1.5 [关系型数据库设计](数据库/数据库系统原理.md#515-关系型数据库设计)

#### 5.1.6 [ER图](数据库/数据库系统原理.md#516-ER图)
...
#### 5.3.1 [数据类型](数据库/MySQL.md#531-数据类型)

#### 5.3.2 [权限管理](数据库/MySQL.md#532-权限管理)

#### 5.3.3 [视图](数据库/MySQL.md#533-视图)

#### 5.3.4 [索引](数据库/MySQL.md#534-索引)

#### 5.3.5 [查询性能优化](数据库/MySQL.md#535-查询性能优化)

#### 5.3.6 [存储引擎](数据库/MySQL.md#536-存储引擎)

#### 5.3.7 [扩展阅读](数据库/MySQL.md#537-扩展阅读)
...
#### 5.6.1 [简介](数据库/Redis.md#561-简介)

#### 5.6.2 [数据类型](数据库/Redis.md#562-数据类型)

#### 5.6.3 [常用命令](数据库/Redis.md#563-常用命令)

#### 5.6.4 [持久化](数据库/Redis.md#564-持久化)

#### 5.6.5 [事务](数据库/Redis.md#565-事务)

#### 5.6.6 [发布和订阅](数据库/Redis.md#566-发布和订阅)

#### 5.6.7 [事件](数据库/Redis.md#567-事件)

#### 5.6.8 [数据淘汰策略](数据库/Redis.md#568-数据淘汰策略)

#### 5.6.9 [分布式相关](数据库/Redis.md#569-分布式相关)

#### 5.6.10 [扩展阅读](数据库/Redis.md#5610-扩展阅读)
