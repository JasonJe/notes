...
$$b_{1}^{\text{new}}=y_{1}-\sum_{i=3}^{n} \alpha_{i} y_{i} x_{i}^{T} x_{1}-\alpha_{1}^{\text{new}} y_{1} x_{1}^{T} x_{1}-\alpha_{2}^{\text{new}} y_{2} x_{2}^{T} x_{1} \\ \Rightarrow b_{1}^{\text{new}}=b^{\text{old}}-E_{1}-y_{1}\left(\alpha_{1}^{\text{new}}-\alpha_{1}^{\text{old}}\right) x_{1}^{T} x_{1} -y_{2}\left(\alpha_{2}^{\text{new}}-\alpha_{2}^{\text{old}}\right) \boldsymbol{x}_{2}^{T} \boldsymbol{x}_{\mathbf{1}}$$
