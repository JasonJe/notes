...
堆是一颗完全二叉树，其中根节点总大于或等于任何一个子节点称为**最大堆**。父节点总小于或等于任何一个子节点称为**最小堆**。

在堆中，元素被赋予优先级。当访问元素时，具有最高优先级的元素最先取出。堆具有最高级先出的行为特征。
...
针对一组带有确定权值的叶子节点，构造具有最小带权路径长度的二叉树。
